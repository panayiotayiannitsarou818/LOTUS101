...
def _story_md():
    return """
**Η εφαρμογή αυτή γεννήθηκε από μια εσωτερική ανάγκη:** να θυμίσει ότι **κανένα παιδί δεν πρέπει να μένει στο περιθώριο**.  
Το παιδί δεν είναι απλώς ένα όνομα σε λίστα. Είναι παρουσία, ψυχή, μέλος μιας ομάδας.  
Μια απερίσκεπτη κατανομή ή ένας λανθασμένος παιδαγωγικός χειρισμός μπορεί να ταράξει την εύθραυστη ψυχική ισορροπία ενός παιδιού — και μαζί της, την ηρεμία μιας οικογένειας.

Όπως έγραψε ο John Donne, «Κανένας άνθρωπος δεν είναι νησί» (“No man is an island”)¹: κανείς δεν υπάρχει απομονωμένος· ό,τι συμβαίνει σε έναν, αφορά όλους.  
Είμαστε μέρος ενός ευρύτερου συνόλου· η μοίρα, η χαρά ή ο πόνος του άλλου μας αγγίζουν, γιατί είμαστε συνδεδεμένοι.

Στο σχολείο αυτό γίνεται πράξη: κάθε απόφαση είναι πράξη παιδαγωγικής ευθύνης.  
Ένα πρόγραμμα κατανομής δεν είναι ποτέ απλώς ένα τεχνικό εργαλείο.  
Είναι **έκφραση παιδαγωγικής ευθύνης** και **κοινωνικής ευαισθησίας**.  
Δεν είναι μόνο αλγόριθμος· είναι εμπιστοσύνη στο μέλλον — των παιδιών και της κοινωνίας.
...
with st.sidebar:
    ...
    # 3b) Κουμπί/Ενότητα: Ιστορία Δημιουργίας & Πηγή Έμπνευσης
